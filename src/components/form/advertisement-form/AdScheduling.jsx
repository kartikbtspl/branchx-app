...
//   // Watch current form values for these fields
//   const timeSlot = watch("timeSlot") || "6–9 AM";
//   const selectedDays = watch("selectedDays") || [];
...
//   // Toggle day selection inside RHF form state
//   const toggleDay = (day) => {
//     if (selectedDays.includes(day)) {
//       setValue(
//         "selectedDays",
...
//             Available Devices: <strong>200</strong>
//           </span>
//         </div>
...
//         <div>
//           <span className="block text-sm font-medium text-gray-600">
//             Estimated Reach: <strong>20000</strong>
//           </span>
//         </div>
//       </div>
//     </div>
